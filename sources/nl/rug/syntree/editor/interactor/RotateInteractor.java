...
/**
 * This class represents a scalable vector graphics canvas rotate interactor.
 * 
 * @author <a href="mailto:harm.brouwer[at]rug.nl">Harm Brouwer</a>
 * @version 1.0
 * @since 1.0
 */
public class RotateInteractor extends AbstractRotateInteractor {
	/**
	 * Constructs a new rotate interactor.
	 */
	public RotateInteractor() {
		super();
	}
